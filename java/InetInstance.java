...
class InetInstance{
 ...
 System.out.println( "Is Address-1 equals to Address-2? : " + address1.equals(address2)); //false
 ...
 // returns host name, which is same as IP address in this case
 ...
 // false, as the given site has only one server
 ...
 // returns fully qualified domain name for this IP address.
...
address1.getCanonicalHostName());
 ...
 // to check if the InetAddress is an unpredictable address..
